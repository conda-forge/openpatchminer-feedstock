...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openpatchminer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13332&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openpatchminer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openpatchminer` can be installed with:

```
conda install openpatchminer
```

It is possible to list all of the versions of `openpatchminer` available on your platform with:
